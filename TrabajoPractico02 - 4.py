#TRABAJO PRACTICO REALIZADO POR LOS ALUMNOS JOAQUIN DEMARCHI NICASTRO, PABLO NORBERTO PEREZ, GUIDO MONTANA Y BAUTISTA FERNANDEZ SAINZ DE LA COMISION 106, GRUPO 6
#REVISAR ERROR EN LA LINEA 539 SE VA DEL ARRAY EL INDICE
...
vuelos = [
    ...
    ["4","LATAM", "Río Janeiro", "Buenos Aires", "20/08/2025", "22:30"],
    ...
    ["9","LATAM", "San Pablo", "Quito", "29/08/2025", "15:00"],
...
def buscarAsientos():
    ...
    if i >= len(vuelos):
        ...
        fecha = datetime.datetime.strptime(vuelos[i][4], "%d/%m/%Y")
    ...
    while salida != "N":
        while flag == True and i < 5:
            if aereolineas[0][i] == "":
                ...
                if aereolineas[3][i] == "ARG":
                    contArg = contArg + 1
                        
                elif aereolineas[3][i] == "CHI":
                    contChi = contChi + 1
                        
                elif aereolineas[3][i] == "BRA":
                    contBra = contBra + 1
            ...
            if i == 5:
                print("esta todo lleno")
            else:
                print("aereolineas cargadas")
...
def comprobacionPrecio(precioVuelos,contArray):
    flag = True
    while len(precioVuelos[contArray]) == 0:
        precioVuelos[contArray] = input("El espacio no puede estar vacio, reintente: ")
        while flag == True:
            if precioVuelos[contArray][0] != "$":
                precioVuelos[contArray] = input("Valor debe empezar con $, ingrese nuevamente: ") 
            else:
                flag = False
...
def crearvuelo(vuelos,precioVuelos):
    ...
    while contArray < 20 and flag1 == True:
            ...
            while flag == True: #aseguramos que la aereolinea cargada en el vuelo sea una anteriormente aceptada por el sistema
                vuelos[contArray][1] = input("Ingrese el  nombre de su aerolinea: ")
                i = 0 
                while vuelos[contArray][1] != aereolineas[0][i] and i <5:
                    i += 1
                if i == 5:
            ...
            precioVuelos[contArray]= str(input("Ingrese el precio de su vuelo: "))
            comprobacionPrecio(precioVuelos,contArray)
...
def modificarVuelo(vuelos, precioVuelos):
    ...
    f = True
    while f:
        codvuelo = input("Ingrese el codigo de vuelo a modificar: ")
        i = 0
        while i < 20 and f:
            if vuelos[i][0] == codvuelo:
                while opc == "S":
                    ...
                    while opcion != "Fecha" and opcion != "Nombre" and opcion != "Origen" and opcion != "Destino" and opcion != "Hora" and opcion != "Precio":
                        ...
                        opcion = input("Ingrese un campo a modificar (Nombre/Origen/Destino/Fecha/Hora/Precio): ").capitalize()
...
def menugestionVuelos(opc2):
    ...
    while opc2 != 4:
        ...
        while f:
            try:
                opc2 = int(input("Ingresa un número entero: "))
                print("Has ingresado:", opc2)
...
def subMenuCeo(opc, opc2):
    ...
    while opc != 4:
        ...
        while f:
            try:
                opc = int(input("Ingresa un número entero: "))
                print("Has ingresado:", opc)
                f = False  # Sale del bucle si la conversión es exitosa
            except ValueError:
                print("¡Error! Ingresa un número entero válido.")
        ...
        match opc:
            ...
            case 4: limpiarConsola(), inicioSesion(opc,opc2)
